          ...
          {process.env.NODE_ENV === 'development' && summary && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mt-6">
              ...
              <div className="text-xs text-yellow-700">
                Summary Length: {summary.length} characters | Language: {language} | Voice Type: {useElevenLabs ? 'ElevenLabs' : 'Browser TTS'} | ElevenLabs Voice: {selectedElevenLabsVoice || 'Auto'} | Speech Available: {isBrowser && speechSynthesis ? 'Yes' : 'No'}
              </div>
            </div>
          )}
        </div>
